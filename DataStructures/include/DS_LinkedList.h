...
namespace DataStructures
{
	...
	* 
	* By Kevin Jenkins (http://www.hexkar.org)
	...
	*/
	...
	template <class CircularLinkedListType>
	inline bool CircularLinkedList<CircularLinkedListType>::IsAtBeginning()
	{
		return position == root;
	}

	template <class CircularLinkedListType>
	inline bool CircularLinkedList<CircularLinkedListType>::IsAtEnd()
	{
		return (root && position == root->previous);
	}
